        ...
        function calculateResistance() {
            ...
            var band5 = parseFloat(document.getElementById("Band5").value);
            var resistance = (band1 * 100 + band2 * 10 + band3) * Math.pow(10, band4);
            var resistanceText = resistance.toString();
            if (resistance >= 1000 && resistance < 1000000) {
                resistanceText = (resistance / 1000) + "kΩ";
            } else if (resistance >= 1000000) {
                resistanceText = (resistance / 1000000) + "MΩ";
            } else {
                resistanceText += "Ω";
            }
        ...
        selectElements.forEach(function(selectElement) {
            selectElement.addEventListener('change', calculateResistance);
        });
